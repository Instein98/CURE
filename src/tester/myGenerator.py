...
if __name__ == "__main__":
    ...
    projPath = Path('/home/yicheng/check-apr/dataset/chart-1f')
    projName = 'Chart-1f'
    generateMeta(projPath, projName, allin=True)
    rerank(projPath, projName, allin=True)
    ...
    # projPath = Path('/home/yicheng/check-apr/dataset/lang-1f')
    # projName = 'Lang-1f'
    # genPatchedClassesAllIn(projPath, projName)
    # prepareMutInputAllIn(projPath, projName)
    # generatePatchesAllIn(projName)
    ...
    # projPath = Path('/home/yicheng/check-apr/CURE/candidate_patches/d4j-test')
    ...
    # # rerank
    # metaFile = Path('/home/yicheng/check-apr/CURE/candidate_patches/d4j-test/meta.txt')
    # quixbugs_meta = read_defects4j_meta(str(metaFile))
